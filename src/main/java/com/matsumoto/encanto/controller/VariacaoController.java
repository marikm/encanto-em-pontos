...
public class VariacaoController {
    ...
    public ResponseEntity<VariacaoResponse> criar(@PathVariable Integer id,@Valid @RequestBody VariacaoRequest variacaoRequest) {
    ...
    public ResponseEntity<VariacaoResponse> atualizar(@PathVariable Integer id, @Valid @RequestBody VariacaoRequest variacaoRequest) {
